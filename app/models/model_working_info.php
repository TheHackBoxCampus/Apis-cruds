<?php
    ...
    class model_working_info {
        ...
        public function __construct(public $id = 1, public $staff = 1, public $years_exp = 4, public $months_exp = 2, public $id_work_reference = 1, public $id_personal_ref = 1, public $start_contract, public $end_contract) {
            $this->id = $id;     
            $this->staff = $staff;     
            ...
            $this->start_contract = date('d/m/Y');     
            $this->end_contract = date('d/m/Y');     
        }
